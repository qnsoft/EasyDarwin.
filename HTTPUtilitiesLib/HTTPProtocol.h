...
enum
{
    ...
    httpAccessControlAllowCredentialsHeader = 50,
    httpAccessControlAllowMethodsHeader = 51,
    httpAccessControlAllowHeadersHeader = 52,
    httpSetCookieHeader = 53,
    httpOriginHeader = 54,

	httpCookieHeader = 55,

	httpNumHeaders = 56,
	httpIllegalHeader = 57
};
