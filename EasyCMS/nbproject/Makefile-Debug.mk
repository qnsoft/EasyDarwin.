...
${OBJECTDIR}/APIModules/EasyRedisModule/EasyRedisHandler.o: APIModules/EasyRedisModule/EasyRedisHandler.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -IAPICommonCode -IAPIStubLib -IPrefsSourceLib -IServer.tproj -I../CommonUtilitiesLib -I../HTTPUtilitiesLib -I../Include -I. -I../EasyProtocol/Include -I../EasyProtocol/jsoncpp/include -IAPIModules/EasyAuthModule -IAPIModules/EasyRedisModule -I../EasyRedisClient -I../Include/FFmpeg/linux -include ../Include/PlatformHeader.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/APIModules/EasyRedisModule/EasyRedisHandler.o APIModules/EasyRedisModule/EasyRedisHandler.cpp
